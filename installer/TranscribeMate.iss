...
#define MyAppVersion "26.01.25.010"
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Parameters: "--install-gpu"; Description: "Install GPU dependencies (first run)"; Flags: postinstall skipifsilent ignoreerrors
