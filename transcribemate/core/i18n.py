...
I18N: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "transcribe.diarization": "Enable speaker diarization (optional)",
        "transcribe.diarization_min": "Min speakers (0=auto)",
        "transcribe.diarization_max": "Max speakers (0=auto)",
        "transcribe.diarization_review": "Review speaker names after each file",
        "transcribe.srt_speakers": "Add speaker names to SRT/video subtitles",
        "transcribe.show_unmapped": "Show raw SPEAKER_XX labels when name is missing",
        "transcribe.profile_prefill": "Prefill speaker names from global profile",
        ...
        "actions.review_speakers": "Review speakers…",
        "actions.batch_speakers": "Batch speakers…",
        ...
        "step.diarize": "Speaker diarization",
        "step.review_speakers": "Speaker review",
        ...
        "speaker.review.title": "Speaker Review",
        "speaker.review.mapping": "Map labels to names",
        "speaker.review.preview": "Transcript preview",
        "speaker.review.pick_sidecar": "Choose diarization sidecar",
        "speaker.review.pick_folder": "Choose folder with diarization sidecars",
        "speaker.review.apply": "Apply",
        "speaker.review.skip": "Skip",
        "speaker.review.merge_prev": "Merge with previous",
        "speaker.review.split_mid": "Split selected",
        "speaker.review.segment_speaker": "Segment speaker",
        "speaker.review.saved": "Speaker mapping saved and transcript re-exported.",
        "speaker.review.batch_saved": "Batch speaker mapping applied to {count} files.",
        "speaker.review.none_found": "No diarization sidecar files were found in the selected folder.",
    },
    "cs": {
        ...
        "transcribe.diarization": "Zapnout rozpoznání řečníků (volitelné)",
        "transcribe.diarization_min": "Min. řečníků (0=auto)",
        "transcribe.diarization_max": "Max. řečníků (0=auto)",
        "transcribe.diarization_review": "Po každém souboru upravit jména řečníků",
        "transcribe.srt_speakers": "Přidat jména řečníků do SRT/titulků ve videu",
        "transcribe.show_unmapped": "Zobrazit SPEAKER_XX, když chybí jméno",
        "transcribe.profile_prefill": "Předvyplnit jména řečníků z globálního profilu",
        ...
        "actions.review_speakers": "Upravit řečníky…",
        "actions.batch_speakers": "Hromadně řečníky…",
        ...
        "step.diarize": "Rozpoznání řečníků",
        "step.review_speakers": "Kontrola řečníků",
        ...
        "speaker.review.title": "Kontrola řečníků",
        "speaker.review.mapping": "Přiřazení jmen",
        "speaker.review.preview": "Náhled přepisu",
        "speaker.review.pick_sidecar": "Vyber diarizační sidecar",
        "speaker.review.pick_folder": "Vyber složku s diarizačními sidecary",
        "speaker.review.apply": "Použít",
        "speaker.review.skip": "Přeskočit",
        "speaker.review.merge_prev": "Sloučit s předchozím",
        "speaker.review.split_mid": "Rozdělit vybraný",
        "speaker.review.segment_speaker": "Řečník segmentu",
        "speaker.review.saved": "Mapování řečníků uloženo a přepis znovu exportován.",
        "speaker.review.batch_saved": "Hromadné mapování řečníků aplikováno na {count} souborů.",
        "speaker.review.none_found": "Ve vybrané složce nebyly nalezeny diarizační sidecary.",
    },
}
